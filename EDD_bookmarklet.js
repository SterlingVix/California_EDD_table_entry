...
window.setTimeout(function () {
    ...
    populateButton.addEventListener('click', function (event) {
        ...
        var pastedData = window.customTextInputArea.value;
        var inputArray = [];
        ...
        var additionalWorkRecordsRadioButtons = document.querySelectorAll('input[type="radio"]');
        var additionalWorkRecordsRadioButton = additionalWorkRecordsRadioButtons[additionalWorkRecordsRadioButtons.length - 2];
